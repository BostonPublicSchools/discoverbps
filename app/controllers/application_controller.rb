...
class ApplicationController < ActionController::Base
  ...
  before_action :set_current_student_from_params
  ...
  def set_current_student_from_params
    return unless params[:student_id].present?
  ...
  def after_sign_in_path_for(resource)
    if resource.present? && resource.instance_of?(::User)
      root_url
    elsif resource.present? && resource.instance_of?(::Admin)
      admin_root_url
    else
      root_url
    end
